<head>
  ...
  <meta property="fb:admins" content="{100000904223352}"/>
  ...
  <!-- Theme styles END -->
  <link href="{{asset('assets/global/plugins/slider-layer-slider/skins/fullwidth/skin.css')}}" rel="stylesheet" type="text/css">
</head>